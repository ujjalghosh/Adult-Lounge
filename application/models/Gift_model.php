...
class Gift_model extends CI_model {
	...
	public function get_received() {
		$this->db->select('UG.created_at, UT.name as username, UT.image, GT.gift_name as gift_name, GT.gift_image_path,UG.gift_credit');
		...
		$this->db->order_by('UG.created_at', 'DESC');
