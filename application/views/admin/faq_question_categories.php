        ...
        <div class="content-header">
            <div class="leftside-content-header">
                <ul class="breadcrumbs">
                    ...
                    <li><a>Manage Question Categories</a></li>
                </ul>
            </div>
        </div>
        <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="<?=base_url('admin/settings/add_question_category?mode=add')?>" class="btn btn-wide btn-primary btn-sm pull-right">Add New Question Category</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                   <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url('admin/settings/add_question_category?mode=edit&id='.$dis_list['id'])?>" title="edit"><i class="fa fa-fw fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                            $i++;
