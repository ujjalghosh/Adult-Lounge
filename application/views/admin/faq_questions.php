            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="<?=base_url('admin/settings/add_question?mode=add')?>" class="btn btn-wide btn-primary btn-sm pull-right">Add New Question</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                   <?php
                                    ...
                                    <tr>
                                        <td><?=$i?></td>
                                        <td><?=stripslashes($dis_list['category'])?></td>
                                        <td><?=stripslashes($dis_list['question'])?></td>
                                        <td><a href="javascript:void(0)" id="<?=$dis_list['id']?>" class="change-status" data-table="faq_question_categories" data-url="admin/services/change_status" title="Status | Green:Active, Red:InActive">
                                        ...
                                        <td><a href="<?=base_url('admin/settings/add_question?mode=edit&id='.$dis_list['id'])?>" title="edit"><i class="fa fa-fw fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                            $i++;
