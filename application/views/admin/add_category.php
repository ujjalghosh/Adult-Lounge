        ...
        <div class="content-header">
            <div class="leftside-content-header">
                <ul class="breadcrumbs">
                    ...
                    <li><a><?php if($post_attr['mode'] == 'add'){ echo 'Add'; }else{ echo 'Edit'; }?> Category</a></li>
                </ul>
            </div>
        </div>
        <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel">
                    <div class="panel-content">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="<?=base_url('admin/services/save_category_data')?>" return_to="<?=base_url('admin/categories')?>" class="form-horizontal commonFormSubmitByAjax" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="email2" class="col-sm-4 control-label">Category Name *</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" onclick="location.href='<?=base_url('admin/categories')?>';" class="btn btn-danger">Cancel</button>
