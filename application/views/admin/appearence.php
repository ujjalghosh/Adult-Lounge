    ...
    <div class="content-header">
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a>Appearence Management</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="row">
                ...
                <div class="col-xs-2">
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="<?=base_url('admin/add-appearence')?>" class="btn btn-wide btn-primary btn-sm pull-right">Add New Appearence</a>
                        </div>
                    </div>
                </div>
            </div>
