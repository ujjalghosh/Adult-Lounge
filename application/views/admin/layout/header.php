...
<!-- Mirrored from myiideveloper.com/helsinki/last-version/helsinki_green-dark/src/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2019 13:50:24 GMT -->
...
<head>
    ...
    <!--load progress bar-->
    <script src="<?=base_url()?>backend/vendor/pace/pace.min.js"></script>
    <link href="<?=base_url()?>backend/vendor/pace/pace-theme-minimal.css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="<?=base_url()?>backend/vendor/select2/css/select2.min.css">
    <link rel="stylesheet" href="<?=base_url()?>backend/vendor/select2/css/select2-bootstrap.min.css">
    <link rel="stylesheet" href="<?=base_url()?>backend/vendor/sweetalert/sweetalert.css">
    <link rel="stylesheet" href="<?=base_url()?>backend/vendor/data-table/media/css/dataTables.bootstrap.min.css">
    <!--SECTION css-->
    <!-- ========================================================= -->
    <!--Notification msj-->
    <link rel="stylesheet" href="<?=base_url()?>backend/vendor/toastr/toastr.min.css">
    <!--Magnific popup-->
                            ...
                            <div class="drop-content">
                                <div class="widget-list list-left-element">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_1.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_2.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_3.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_4.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_5.jpg" /></div>
                                                <div class="text">
        ...
        <div class="drop-footer">
            <a>See all notifications</a>
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <!--<div class="user-photo">
                            <img alt="profile photo" src="<?=base_url()?>backend/images/avatar/avatar_user.jpg" />
                        </div>-->
                        <div class="user-info">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                ...
                                <li> <a href="<?=base_url('admin/change/password')?>"><i class="fa fa-lock" aria-hidden="true"></i> Change Password</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="header-section">
                    <a href="javascript:void(0)" class="admin-logout" data-toggle="tooltip" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <div class="page-body">
