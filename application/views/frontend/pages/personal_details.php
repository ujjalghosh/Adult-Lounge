...
?>
                                ...
                                <div class="form-widget">
                                    <div class="form-two-col">
                                        <div class="form-group">
                                            <input type="text" placeholder="Card Number" class="form-control cardnumber" onkeypress="return isNumber(this.event)" name="editpro_card" id="editpro_card" value="<?=$billingdtls->card_no?>" />
                                        </div>
                                        <div class="form-group">
                                            <div class="inline-items vcenter-items">
                                                <!--<span>Expiry</span>-->
                                                <input type="text" placeholder="Expiry Month (MM)" class="form-control month" style="width: 48%;" onkeypress="return isNumber(this.event)" name="editpro_cardm" id="editpro_cardm" value="<?=$billingdtls->card_month?>" />
                                                <input type="text" placeholder="Expiry Year (YYYY)" class="form-control year" style="width: 48%;" onkeypress="return isNumber(this.event)" name="editpro_cardy" id="editpro_cardy" value="<?=$billingdtls->card_year?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-two-col">
                                        <div class="form-group">
                                            <input type="password" placeholder="CVV" class="form-control cvv" onkeypress="return isNumber(this.event)" name="editpro_card_cvv" id="editpro_card_cvv" value="<?=$billingdtls->card_cvv?>" />
                                        </div>
                                    </div>
                                    <div class="form-two-col">
                                        <div class="form-group">
                                            <input type="text" placeholder="Address" class="form-control addrs" name="editpro_address" id="editpro_address" value="<?=$billingdtls->address_one?>"/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Postcode" class="form-control postcode" onkeypress="return isNumber(this.event)" name="editpro_pin" id="editpro_pin" value="<?=$billingdtls->pincode?>"/>
                                        </div>
                                    </div>
                                </div>
